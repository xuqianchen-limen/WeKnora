export default {
  ...
  datasource: {
    ...
    permissionHint: "앱이 위키 공간의 멤버로 추가되어야 콘텐츠에 접근할 수 있습니다:",
    permissionStep1: "페이슈를 열고 동기화할 위키 공간으로 이동",
    permissionStep2: "오른쪽 상단 '...' > '설정' > '멤버 관리' 클릭",
    permissionStep3: "페이슈 앱을 검색하여 위키 공간 멤버로 추가",
