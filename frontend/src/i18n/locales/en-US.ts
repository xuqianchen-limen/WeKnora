...
\
  ...
  datasource: {
    ...
    noResourcesDesc_wecom_doc: 'Ensure the app is added as a "Callable App" in Admin Console > Collaboration > Docs > API',
    ...
    guideStep1_wecom_doc: 'Add the app as a "Callable App" in Admin Console > Collaboration > Docs > API',
    guideStep2_wecom_doc: 'Ensure the app "Visible Scope" includes the members/departments to sync',
    guideStep3_wecom_doc: 'Fill in Corp ID and Secret, then click retry',
    ...
    connectorDesc: {
      ...
      wecom_doc: 'Sync documents from WeCom Docs',
    },
    field: {
      appId: 'App ID',
    ...
    wecomCallbackTitle: 'Callback URL Setup (unlocks "Callable Apps" setting)',
    wecomCallbackDesc: 'WeCom admin requires configuring a "Message Receiving Server URL" before you can set "Trusted IPs" and "Callable Apps". Enter the Token and EncodingAESKey from WeCom admin here, save, then paste the generated callback URL into WeCom admin.',
    wecomCallbackUrl: 'Callback URL (paste into WeCom admin "Message Receiving Server URL")',
    wecomCallbackSaveFirst: 'Save the data source first to generate the callback URL',
    copyUrl: 'Copy URL',
    copied: 'Copied',
    ...
    prereqBarText_wecom_doc: 'First time? Click to expand WeCom app setup guide',
    prereqStep1Brief_wecom_doc: 'Configure Callback URL (unlocks further settings)',
    prereqStep1Desc_wecom_doc: 'Save data source first → Expand "Callback URL Setup" below → Enter Token/EncodingAESKey from WeCom admin → Paste generated URL into WeCom admin "Message Receiving Server URL"',
    prereqStep2Brief_wecom_doc: 'Authorize app for Docs API',
    prereqStep2Desc_wecom_doc: 'Admin Console → Collaboration → Docs → Scroll to API section at bottom → Add your app to "Callable Apps"',
    prereqStep3Brief_wecom_doc: 'Confirm app visible scope',
    prereqStep3Desc_wecom_doc: 'Admin Console → App Management → App detail → Ensure "Visible Scope" includes target members/departments',
