...
/example\.(net|org)/`,
  ...
  datasource: {
    ...
    permissionHint: 'Приложение должно быть добавлено как участник пространства вики для доступа к контенту:',
    permissionStep1: 'Откройте Feishu и перейдите в пространство вики для синхронизации',
    permissionStep2: 'Нажмите "..." > "Настройки" > "Управление участниками"',
    permissionStep3: 'Найдите и добавьте приложение Feishu как участника пространства',
